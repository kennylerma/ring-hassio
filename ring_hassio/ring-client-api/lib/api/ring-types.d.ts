...
export declare function isBatteryCameraKind(kind: RingCameraKind): boolean;
export declare const RingCameraModel: {
    readonly [P in RingCameraKind]: string;
};
export declare type AlarmMode = 'all' | 'some' | 'none';
export declare type ThermostatMode = 'heat' | 'cool' | 'off' | 'aux';
...
export declare type AssetKind = 'base_station_v1' | 'beams_bridge_v1' | 'floodlight_v2' | string;
...
export declare type ChimeSoundKind = 'motion' | 'ding';
...
export declare type DingKind = 'motion' | 'ding' | 'on_demand' | 'alarm' | 'on_demand_link' | 'door_activity' | 'key_access' | 'DELETED_FOOTAGE' | 'OFFLINE_FOOTAGE' | 'OFFLINE_MOTION';
...
export declare type DingState = 'ringing' | 'connected' | 'timed_out' | 'completed';
