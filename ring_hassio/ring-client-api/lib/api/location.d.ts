...
export declare class Location extends Subscribed {
    ...
    onDeviceDataUpdate: import("rxjs").Observable<RingDeviceData>;
    onDeviceList: import("rxjs").Observable<SocketIoMessage>;
    onDevices: import("rxjs").Observable<RingDevice[]>;
    onSessionInfo: import("rxjs").Observable<AssetSession[]>;
